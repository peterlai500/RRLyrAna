...
#plt.savefig(f"figures/dmu-Ng22PLZ_RR0-g-Mura", dpi=300)
plot_PLZhist("g", "RR0", He25_PLZcoeffs, 'He25', mu_true)
#plt.savefig(f"figures/dmu-He25PLZ_RR0-g-Mura", dpi=300)
plot_PLZhist("g", "RR0", Na24_PLZcoeffs01, 'Na24', mu_true)
#plt.savefig(f"figures/dmu-Na24PLZ01_RR0-g-Mura", dpi=300)
plot_PLZhist("g", "RR0", Na24_PLZcoeffs02, 'Na24', mu_true)
#plt.savefig(f"figures/dmu-Na24PLZ02_RR0-g-Mura", dpi=300)
plot_PLZhist("g", "RR0", Na24_PLZcoeffs03, 'Na24', mu_true)
#plt.savefig(f"figures/dmu-Na24PLZ03_RR0-g-Mura", dpi=300)
plot_PLZhist("g", "RR0", Na24_PLZcoeffs04, 'Na24', mu_true)
#plt.savefig(f"figures/dmu-Na24PLZ04_RR0-g-Mura", dpi=300)

# r band
plot_PLZhist("r", "RR0", Ng22_PLZcoeffs, 'Ng22', mu_true)
# plt.savefig(f"figures/dmu-Ng22PLZ_RR0-r-Mura", dpi=300)
plot_PLZhist("r", "RR0", He25_PLZcoeffs, 'He25', mu_true)
# plt.savefig(f"figures/dmu-He25PLZ_RR0-r-Mura", dpi=300)
plot_PLZhist("r", "RR0", Na24_PLZcoeffs01, 'Na24', mu_true)
# plt.savefig(f"figures/dmu-Na24PLZ01_RR0-r-Mura", dpi=300)
plot_PLZhist("r", "RR0", Na24_PLZcoeffs02, 'Na24', mu_true)
# plt.savefig(f"figures/dmu-Na24PLZ02_RR0-r-Mura", dpi=300)
plot_PLZhist("r", "RR0", Na24_PLZcoeffs03, 'Na24', mu_true)
# plt.savefig(f"figures/dmu-Na24PLZ03_RR0-r-Mura", dpi=300)
plot_PLZhist("r", "RR0", Na24_PLZcoeffs04, 'Na24', mu_true)
# plt.savefig(f"figures/dmu-Na24PLZ04_RR0-r-Mura", dpi=300)

# i band
plot_PLZhist("i", "RR0", Ng22_PLZcoeffs, 'Ng22', mu_true)
# plt.savefig(f"figures/dmu-Ng22PLZ_RR0-i-Mura", dpi=300)
plot_PLZhist("i", "RR0", He25_PLZcoeffs, 'He25', mu_true)
# plt.savefig(f"figures/dmu-He25PLZ_RR0-i-Mura", dpi=300)
plot_PLZhist("i", "RR0", Na24_PLZcoeffs01, 'Na24', mu_true)
# plt.savefig(f"figures/dmu-Na24PLZ01_RR0-i-Mura", dpi=300)
plot_PLZhist("i", "RR0", Na24_PLZcoeffs02, 'Na24', mu_true)
# plt.savefig(f"figures/dmu-Na24PLZ02_RR0-i-Mura", dpi=300)
plot_PLZhist("i", "RR0", Na24_PLZcoeffs03, 'Na24', mu_true)
# plt.savefig(f"figures/dmu-Na24PLZ03_RR0-i-Mura", dpi=300)
plot_PLZhist("i", "RR0", Na24_PLZcoeffs04, 'Na24', mu_true)
# plt.savefig(f"figures/dmu-Na24PLZ04_RR0-i-Mura", dpi=300)
...
# plt.savefig(f"figures/dmu-Ng22PLZ_RR1-g-Mura", dpi=300)
plot_PLZhist("g", "RR1", He25_PLZcoeffs, 'He25', mu_true)
# plt.savefig(f"figures/dmu-He25PLZ_RR1-g-Mura", dpi=300)

# r band
plot_PLZhist("r", "RR1", Ng22_PLZcoeffs, 'Ng22', mu_true)
# plt.savefig(f"figures/dmu-Ng22PLZ_RR1-r-Mura", dpi=300)
plot_PLZhist("r", "RR1", He25_PLZcoeffs, 'He25', mu_true)
# plt.savefig(f"figures/dmu-He25PLZ_RR1-r-Mura", dpi=300)

# i band
plot_PLZhist("i", "RR1", Ng22_PLZcoeffs, 'Ng22', mu_true)
# plt.savefig(f"figures/dmu-Ng22PLZ_RR1-i-Mura", dpi=300)
plot_PLZhist("i", "RR1", He25_PLZcoeffs, 'He25', mu_true)
# plt.savefig(f"figures/dmu-He25PLZ_RR1-i-Mura", dpi=300)

##################################################
########## RR0+RR1 PLZ ###########################
# g band
plot_PLZhist("g", "RR0+RR1", Ng22_PLZcoeffs, 'Ng22', mu_true)
# plt.savefig(f"figures/dmu-Ng22PLZ_RR01-g-Mura", dpi=300)
plot_PLZhist("g", "RR0+RR1", Na24_PLZcoeffs01, 'Na24', mu_true)
# plt.savefig(f"figures/dmu-Na24PLZ01_RR01-g-Mura", dpi=300)
plot_PLZhist("g", "RR0+RR1", Na24_PLZcoeffs02, 'Na24', mu_true)
# plt.savefig(f"figures/dmu-Na24PLZ02_RR01-g-Mura", dpi=300)
plot_PLZhist("g", "RR0+RR1", Na24_PLZcoeffs03, 'Na24', mu_true)
# plt.savefig(f"figures/dmu-Na24PLZ03_RR01-g-Mura", dpi=300)
plot_PLZhist("g", "RR0+RR1", Na24_PLZcoeffs04, 'Na24', mu_true)
# plt.savefig(f"figures/dmu-Na24PLZ04_RR01-g-Mura", dpi=300)

# r band
plot_PLZhist("r", "RR0+RR1", Ng22_PLZcoeffs, 'Ng22', mu_true)
# plt.savefig(f"figures/dmu-Ng22PLZ_RR01-r-Mura", dpi=300)
plot_PLZhist("r", "RR0+RR1", Na24_PLZcoeffs01, 'Na24', mu_true)
# plt.savefig(f"figures/dmu-Na24PLZ01_RR01-r-Mura", dpi=300)
plot_PLZhist("r", "RR0+RR1", Na24_PLZcoeffs02, 'Na24', mu_true)
# plt.savefig(f"figures/dmu-Na24PLZ02_RR01-r-Mura", dpi=300)
plot_PLZhist("r", "RR0+RR1", Na24_PLZcoeffs03, 'Na24', mu_true)
# plt.savefig(f"figures/dmu-Na24PLZ03_RR01-r-Mura", dpi=300)
plot_PLZhist("r", "RR0+RR1", Na24_PLZcoeffs04, 'Na24', mu_true)
# plt.savefig(f"figures/dmu-Na24PLZ04_RR01-r-Mura", dpi=300)
...
# plt.savefig(f"figures/dmu-Na24PLZ01_RR01-i-Mura", dpi=300)
plot_PLZhist("i", "RR0+RR1", Na24_PLZcoeffs02, 'Na24', mu_true)
# plt.savefig(f"figures/dmu-Na24PLZ02_RR01-i-Mura", dpi=300)
plot_PLZhist("i", "RR0+RR1", Na24_PLZcoeffs03, 'Na24', mu_true)
# plt.savefig(f"figures/dmu-Na24PLZ03_RR01-i-Mura", dpi=300)
plot_PLZhist("i", "RR0+RR1", Na24_PLZcoeffs04, 'Na24', mu_true)
# plt.savefig(f"figures/dmu-Na24PLZ04_RR01-i-Mura", dpi=300)
'''
